      ...
      <header className="App-header">
        ...
        <div className='total_amount_card'>
          <div className='card_text'>
            <h3 className='total_amount_symbol'>
               &#8377;{interest}
            </h3>
            <p className='para_total'>Total Simple Interest Calculator</p>
        ...
        <div className='input'>
        <div>
        <TextField id="outlined-basic" label="Principe Amount" variant="outlined"
        ...
        <Button
        onClick={reset}
        style={{color:'black'}} className='btn' variant="outlined">Reset</Button>
